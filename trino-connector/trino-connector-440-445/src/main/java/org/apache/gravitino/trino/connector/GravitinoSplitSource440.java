 ...
 */
public class GravitinoSplitSource440 extends GravitinoSplitSource {
   ...
   */
  public GravitinoSplitSource440(ConnectorSplitSource connectorSplitSource) {
        ...
        .thenApply(
            batch -> {
              List<ConnectorSplit> list =
                  batch.getSplits().stream().map(GravitinoSplit440::new).collect(Collectors.toList());
