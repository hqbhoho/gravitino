 ...
 */
public class GravitinoSplitSource435 extends GravitinoSplitSource {
   ...
   */
  public GravitinoSplitSource435(ConnectorSplitSource connectorSplitSource) {
        ...
        .thenApply(
            batch -> {
              List<ConnectorSplit> list =
                  batch.getSplits().stream().map(GravitinoSplit435::new).collect(Collectors.toList());
